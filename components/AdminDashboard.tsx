                                            ...
                                            <td className="p-3 text-center">
                                                {!user.isApproved ? (
                                                    ...
                                                    <div className="flex justify-center gap-1">
                                                        <button
                                                            onClick={(e) => toggleUserActive(user.id, user.isActive === false)}
                                                            className={`p-2 rounded transition-colors ${user.isActive === false ? 'text-green-500 hover:bg-green-50' : 'text-orange-400 hover:text-orange-600 hover:bg-orange-50'}`}
