        ...
        <div className="flex flex-col gap-6 max-w-7xl mx-auto pb-24 print:w-full print:max-w-none print:pb-0 print:gap-1">
            ...
            <div className={`${isPreview ? 'hidden' : 'block'} bg-white shadow-xl shadow-slate-200 rounded-xl overflow-hidden border border-slate-200 print:hidden`}>
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 p-4 md:p-6 bg-slate-50/50 border-b border-slate-200">
                    ...
                    <HeaderField label="Driver Name" icon={BadgeInfo}><input type="text" value={driverName} onChange={e => setDriverName(e.target.value)} disabled={isCompleted} className="w-full bg-transparent text-sm font-medium text-slate-700 outline-none" placeholder="Driver Name" /></HeaderField>
                ...
                <div className="flex flex-col lg:flex-row border-b border-slate-200">
                    ...
                    <div className="p-6 border-t border-slate-200">
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                            <HeaderField label="Supervisor Name" icon={BadgeInfo}><input type="text" value={svName} onChange={e => setSvName(e.target.value)} disabled={isCompleted} className="w-full text-sm outline-none" /></HeaderField>
