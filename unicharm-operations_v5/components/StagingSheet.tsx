...
export const StagingSheet: React.FC<Props> = ({ existingSheet, onCancel, onLock, initialPreview = false }) => {
    ...
    const handleItemChange = (index: number, field: string, value: any) => {
        ...
        if (['casesPerPlt', 'fullPlt', 'loose'].includes(field)) {
            ...
            if (value !== '' && (Number(value) < 0 || value === '-')) return;
    ...
    return (
        <div className="bg-white shadow-xl shadow-slate-200 rounded-xl pb-24 relative border border-slate-100 flex flex-col min-h-full">
            ...
            {!isPreview && (
                <div className="flex justify-between items-center p-6 border-b border-slate-100 bg-white print:hidden">
                    <div>
                        ...
                        <div className="flex items-center gap-3">
                            <h2 className="text-2xl font-bold text-slate-800 tracking-tight">Staging Check Sheet</h2>
            ...
            <div className={`p-6 bg-slate-50/50 border-b border-slate-100 ${isPreview ? 'hidden' : 'block'} print:hidden`}>
            ...
            <div className={`p-6 ${isPreview ? 'hidden' : 'block'} print:hidden`}>
                    ...
                    <table className="w-full text-sm">
                        <thead className="bg-slate-50 text-slate-600 border-b border-slate-200">
                            <tr>
                                ...
                                <th className="p-3 text-left font-semibold text-xs uppercase tracking-wider">SKU Name</th>
                ...
                {!isLocked && (
                    <div className="mt-4 flex justify-center">
                        <button onClick={handleAddRow} className="flex items-center gap-2 text-sm font-medium text-blue-600 hover:text-blue-700 bg-blue-50 hover:bg-blue-100 px-4 py-2 rounded-lg transition-colors">
