...
export const Layout: React.FC<LayoutProps> = ({ children, currentPage, onNavigate }) => {
  ...
  return (
    <div className="flex h-screen bg-slate-50 overflow-hidden font-sans print:h-auto print:overflow-visible print:block">
      ...
      <div className="w-56 bg-white border-r border-slate-200 flex flex-col no-print flex-shrink-0 transition-all duration-300 z-20">
        <div className="p-4">
      ...
      <div className="flex-1 flex flex-col h-screen overflow-hidden w-full relative print:h-auto print:overflow-visible print:block">
        ...
        <header className="h-16 flex items-center justify-between px-8 bg-white/80 backdrop-blur-sm border-b border-slate-200 z-10 no-print flex-shrink-0 sticky top-0">
          <div>
            <h2 className="text-xl font-bold text-slate-800 capitalize tracking-tight">
                {currentPage.replace('-', ' ').replace('data management', 'Data Management')}
            </h2>
          </div>
          ...
          <div className="flex items-center gap-6">
            ...
            <div className="relative" ref={notificationRef}>
                ...
                {/* Dropdown Menu */}
                {showNotifications && (
                    <div className="absolute right-0 top-12 w-80 bg-white rounded-xl shadow-2xl border border-slate-100 overflow-hidden z-50 animate-in fade-in zoom-in duration-200">
        ...
        {/* Scrollable Content */}
        <main className="flex-1 overflow-auto p-8 relative print:p-0 print:overflow-visible w-full bg-slate-50 print:bg-white print:h-auto">
